...
const _preloadRes = [
    ...
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Prefabs/UI/Pause/UI_Pause', type: 'prefab' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Prefabs/UI/Reward/UI_Reward', type: 'prefab' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/bgm.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/bullet.mp3', type: 'audio' },
    ...
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/fail.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/tance.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/enemyDie.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/enemyHit.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/fightBGM.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/GearCrash.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/gold.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/ice.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/leveup.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/meleeAttack.mp3', type: 'audio' },
    { bundle: ModuleDef.MODULE_ALIENS, url: 'Audio/superAttack.mp3', type: 'audio' },
];
...
export class Start extends Component {
    ...
    protected onLoad(): void {
        ...
        console.log('start load config....11');
    }
